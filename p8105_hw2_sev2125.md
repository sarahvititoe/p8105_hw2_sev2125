...
Read in and clean Mr.Trash Wheel dataset. Omit columns containing notes, use reasonable variable names, omit rows that do not include dupster-specific data, and round the number of sports\_balls.
